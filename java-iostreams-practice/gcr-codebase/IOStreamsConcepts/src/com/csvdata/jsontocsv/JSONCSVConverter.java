...
public class JSONCSVConverter {
	...
	// sample files paths
	String jsonFile = "CSVData/jsontocsv/students.json";
	String csvFile = "CSVData/jsontocsv/students_from_json.csv";
	...
	// sample files paths
	String csvFile = "CSVData/jsontocsv/students.csv";
	String jsonFile = "CSVData/jsontocsv/students_from_csv.json";
