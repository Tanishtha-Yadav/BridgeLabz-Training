...
public class EncryptDecryptCSV {
	...
	// sample file path
	String inputFile = "CSVData/encryptdecrypt/employee.csv";
	String encryptedFile = "CSVData/encryptdecrypt/encrypted_employees.csv";
	...
	// sample file path
	String encryptedFile = "CSVData/encryptdecrypt/encrypted_employees.csv";
	String decryptedFile = "CSVData/encryptdecrypt/decrypted_employees.csv";
